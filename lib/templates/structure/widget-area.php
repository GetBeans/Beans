...
echo beans_get_widget_area( 'before_widgets' ); // @codingStandardsIgnoreLine - WordPress.XSS.EscapeOutput.OutputNotEscaped.
...
if ( 'grid' === beans_get_widget_area( 'beans_type' ) ) {
	beans_close_markup_e( 'beans_widget_area_grid' . _beans_widget_area_subfilters(), 'div' );
		...
		echo beans_get_widget_area( 'after_widgets' ); // @codingStandardsIgnoreLine - WordPress.XSS.EscapeOutput.OutputNotEscaped.
