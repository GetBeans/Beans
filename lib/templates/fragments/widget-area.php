...
function beans_widget_area_sidebar_primary() {
	echo beans_widget_area( 'sidebar_primary' ); // @codingStandardsIgnoreLine - WordPress.XSS.EscapeOutput.OutputNotEscaped.
}
...
function beans_widget_area_sidebar_secondary() {
	echo beans_widget_area( 'sidebar_secondary' ); // @codingStandardsIgnoreLine - WordPress.XSS.EscapeOutput.OutputNotEscaped.
}
...
function beans_widget_area_offcanvas_menu() {
	...
	echo beans_widget_area( 'offcanvas_menu' ); // @codingStandardsIgnoreLine - WordPress.XSS.EscapeOutput.OutputNotEscaped.
}
