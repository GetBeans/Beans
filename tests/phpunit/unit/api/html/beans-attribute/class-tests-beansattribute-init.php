<?php
/**
 * Tests for the init() method of Beans_Attribute.
 *
...
class Tests_BeansAttribute_Init extends HTML_Test_Case {
	...
	/**
	 * Test Beans_Attribute::init() should return null when the method does not exist.
	 */
	public function test_should_return_null_when_method_does_not_exist() {
		$instance = new Beans_Attribute( 'foo', 'data-test' );
		$this->assertNull( $instance->init( 'does_not_exist' ) );
	}

	/**
	 * Test Beans_Attribute::init() should register the callback when the method exists.
	 */
