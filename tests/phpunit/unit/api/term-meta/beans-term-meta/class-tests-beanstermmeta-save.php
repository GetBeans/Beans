<?php
/**
 * Tests for the save() method of Beans_Term_Meta.
 *
...
class Tests_BeansTermMeta_Save extends Term_Meta_Test_Case {
	...
	/**
	 * Test Beans_Term_Meta::save() should return term_ID when doing_ajax.
	 */
	...
	/**
	 * Test Beans_Term_Meta::save() should return term_ID when nonce is invalid.
	 */
	...
	/**
	 * Test Beans_Term_Meta::save() should return term_ID when fields are falsey.
	 */
	...
	/**
	 * Test Beans_Term_Meta::save() should return null when fields are updated.
	 */
