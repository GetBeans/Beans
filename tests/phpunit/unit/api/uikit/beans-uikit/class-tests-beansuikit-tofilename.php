<?php
/**
 * Tests for the to_filename() method of Beans_Uikit.
 *
...
class Tests_BeansUikit_ToFilename extends UIkit_Test_Case {
	...
	/**
	 * Test Beans_Uikit::to_filename() should return null when given an ignored component.
	 */
	...
	/**
	 * Test Beans_Uikit::to_filename() should remove the .min extension from the filename.
	 */
	...
	/**
	 * Test Beans_Uikit::to_filename() should return the component's filename when given absolute path.
	 */
	...
	/**
	 * Test Beans_Uikit::to_filename() should return the component's filename when given relative path.
	 */
