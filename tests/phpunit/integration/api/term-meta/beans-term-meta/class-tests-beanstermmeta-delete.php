<?php
/**
 * Tests for the delete() method of Beans_Term_Meta.
 *
...
class Tests_BeansTermMeta_Delete extends Term_Meta_Test_Case {
	...
	/**
	 * Test Beans_Term_Meta::delete() should remove term meta option from database options table.
	 */
	public function test_should_remove_term_meta_option_from_db_options_table() {
		...
		$term_meta = new Beans_Term_Meta( 'tm-beams' );
