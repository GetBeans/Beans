...
class Tests_BeansRemoveMarkup extends HTML_Test_Case {
	...
	/**
	 * Test beans_remove_markup() should return a Beans_Anonymous_Filters instance.
	 */
	public function test_should_return_anonymous_filter_instance() {
		$this->assertInstanceOf( Beans_Anonymous_Filters::class, beans_remove_markup( 'beans_archive_title' ) );
	}
